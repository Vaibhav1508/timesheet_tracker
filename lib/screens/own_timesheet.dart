...
class OwnTimesheetScreen extends StatefulWidget {
  final String weekid;
  const OwnTimesheetScreen({Key  key, this.weekid}) : super(key: key);

  @override
  _OwnTimesheetScreenState createState() => _OwnTimesheetScreenState();
}

class _OwnTimesheetScreenState extends State<OwnTimesheetScreen> {
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text("Your Timesheet",style: TextStyle(fontSize: 20,color: Colors.blue,fontWeight: FontWeight.bold),),
                    SizedBox(width: 10,)
                  ],
                ),
                SizedBox(
    ...
    return  ListTile(
      ...
      trailing: GestureDetector(
        ...
        onTap: (){
          ...
          Fluttertoast.showToast(msg: 'Timesheet Deleted successfully');
