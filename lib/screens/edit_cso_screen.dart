...
class EditCSOScreen extends StatefulWidget {

  final Cso csoitem;

  const EditCSOScreen({Key key, this.csoitem}) : super(key: key);

  @override
  _EditCSOScreenState createState() => _EditCSOScreenState();
}

class _EditCSOScreenState extends State<EditCSOScreen> {
  ...
  void initState() {
    ...
    getcontracts();
   setState(() {
     dateController.text = widget.csoitem.date;
     timeinput.text = widget.csoitem.start_at;
     timeinput2.text = widget.csoitem.end_at;
     csono.text = widget.csoitem.csono;
     email.text = widget.csoitem.email;
     name.text = widget.csoitem.name;
     reported.text = widget.csoitem.reportedon;
     mobile.text = widget.csoitem.mobile;

     engineer.text = widget.csoitem.engineer;
     description.text = widget.csoitem.description;
     resolution.text = widget.csoitem.resolution;
     contactid.text = widget.csoitem.contractid;

     contact.text = widget.csoitem.contract;
   });
                          ...
                          TextButton(
                            ...
                            onPressed: ()  {
                              ...
                              if(csono==""||dateController.text==""||email.text==""||reported.text==""||
                                ...
                                _firestoreService.updateCSO(widget.csoitem.id,csono.text, name.text, contact.text, email.text,
